CLASS lhc_Incident DEFINITION INHERITING FROM cl_abap_behavior_handler.
  PUBLIC SECTION.
    ...
    CONSTANTS: BEGIN OF mc_status,
                 open        TYPE zde_status2_598 VALUE 'OP',
                 in_progress TYPE zde_status2_598 VALUE 'IP',
                 pending     TYPE zde_status2_598 VALUE 'PE',
                 completed   TYPE zde_status2_598 VALUE 'CO',
                 closed      TYPE zde_status2_598 VALUE 'CL',
                 canceled    TYPE zde_status2_598 VALUE 'CN',
               END OF mc_status.
  ...
  PRIVATE SECTION.
    ...
    METHODS get_history_index EXPORTING ev_incuuid      TYPE sysuuid_x16
                              RETURNING VALUE(rv_index) TYPE zde_his_id_598.
ENDCLASS.
...
** Read root entity entries
    READ ENTITIES OF zr_dt_inct_598 IN LOCAL MODE
     ENTITY Incident
     FIELDS ( CreationDate
...
** Modify status in Root Entity
    MODIFY ENTITIES OF zr_dt_inct_598 IN LOCAL MODE
      ENTITY Incident
      UPDATE
      FIELDS ( IncidentID
               CreationDate
  ...
  METHOD get_instance_features.
    DATA lv_history_index TYPE zde_his_id_598.
    READ ENTITIES OF zr_dt_inct_598 IN LOCAL MODE
       ENTITY Incident
         FIELDS ( Status )
...
* Declaration of necessary variables
    DATA: lt_updated_root_entity TYPE TABLE FOR UPDATE zr_dt_inct_598,
          lt_association_entity  TYPE TABLE FOR CREATE zr_dt_inct_598\_History,
          lv_status              TYPE zde_status2_598,
          lv_text                TYPE zde_text_598,
          lv_exception           TYPE string,
          lv_error               TYPE c,
          ls_incident_history    TYPE zdt_inct_h_598,
          lv_max_his_id          TYPE zde_his_id_598,
          lv_wrong_status        TYPE zde_status2_598.
...
* Customize error messages
        APPEND VALUE #( %tky = <incident>-%tky
                        %msg = NEW zcl_incident_messages_598( textid = zcl_incident_messages_598=>status_invalid
